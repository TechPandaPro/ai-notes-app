...
export default function BlockTypePicker({
  ...
  // return (
  //   <div className="blockTypePicker">
  //     <div className="blockTypeOption blockTypeTextOption">
  //       {/* <div className="blockTypeOptionInner blockTextOption">T</div> */}
  //       <svg
  //         width="35"
  //         height="50"
  //         viewBox="0 0 35 50"
  ...
  //     </div>
  //     <div className="blockTypeOption blockTypeTextOption">
  //       {/* <div className="blockTypeOptionInner blockHeaderOption">H</div> */}
  //       <svg
  //         width="25"
  //         height="30"
  //         viewBox="0 0 25 30"
  ...
  //       {/* <div className="blockTypeOptionInner blockImageOption"> */}
  //       <svg
  //         width="20"
  //         height="16"
  //         viewBox="0 0 20 16"
